                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input name="reference" class="form-control font-weight-bold" value="{{ $store->reference }}" placeholder="Reference Number" required/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control font-weight-bold input-lg" name="warranty" value="{{ $store->warranty }}" placeholder="Product Warranty" type="number" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control font-weight-bold input-lg" name="buy_price" value="{{ $store->buy_price }}" placeholder="Company Price" type="text" required>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input class="form-control font-weight-bold input-lg" name="sell_price" value="{{ $store->sell_price }}" placeholder="Sell Price" type="text" required>
                                                    <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group col-12 mb-2 contact-repeater">
                                    ...
                                    <div data-repeater-list="codes">
                                        ...
                                        <div class="input-group mb-1" data-repeater-item>
                                            <input name="code" {{ $cod->status == 1 ? 'disabled' : '' }}  class="form-control font-weight-bold" value="{{ $cod->code }}" placeholder="Product Bar Code" required/>
                                ...
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary btn-block font-weight-bold btn-lg text-uppercase"><i class="fa fa-send"></i> Update Store</button>
                                </div>
                            </div>
                            {!! Form::close() !!}
