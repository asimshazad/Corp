    ...
    <section class="invoice">
        ...
        <div class="row invoice-logo">
            ...
            <div class="col-xs-6">
                ...
                <div class="text-center">
                    <h5>
                        <span class="label label-default"> Instalment Repayment</span>
                    </h5>
            ...
            <div class="col-sm-6 col-xs-6">
                <div class="well extra-well extra-table2" style="padding: 10px;">
                    ...
                    <ul class="list-unstyled" style="margin-bottom: 0;">
                        <li class="font-size-14">{{ $sell->instalment->customer->name }}</li>
                        <li class="font-size-14">{{ $sell->instalment->customer->phone }}</li>
                        <li class="font-size-14">{{ $sell->instalment->customer->address }}</li>
                    </ul>
                </div>
            </div>
            <!-- /.col -->
            ...
            <div class="col-sm-6 col-xs-6">
                <div class="well extra-well extra-table2" style="padding: 10px;">
                    ...
                    <ul class="list-unstyled" style="margin-bottom: 0;">
                        ...
                        <li class="font-size-14"> <b>Instalment Amount : </b>{{ $sell->amount }} {{ $basic->currency }}</li>
        ...
        <div class="row">
            <div class="col-xs-12 table-responsive">
                <table class="table table-striped extra-table2" style="margin-bottom: 0;">
                    ...
                    <tbody>
                        <tr>
                            <td>{{ \Carbon\Carbon::parse($sell->pay_date)->format('dS-F-Y') }}</td>
                            <td>{{ $sell->instalment->custom }}</td>
                            <td>{{ $sell->amount }} - {{ $basic->currency }}</td>
                            <td>{{ $sell->pay_amount }} - {{ $basic->currency }}</td>
                            <td>{{ $sell->amount - $sell->pay_amount }} - {{ $basic->currency }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table extra-table" style="margin-bottom: 0px">
                            <tr class="bg-grey bg-lighten-4">
                                ...
                                <td class="text-bold-600 text-right">{{ $sell->amount }} - {{ $basic->currency }}</td>
                            </tr>
                            <tr class="bg-grey bg-lighten-4">
                            ...
                            <tr class="bg-grey bg-lighten-4">
                                ...
                                <td class="red text-bold-600 text-right">{{ $sell->amount - $sell->pay_amount }} - {{ $basic->currency }}</td>
                            </tr>
                        <tr>
                            <td colspan="2" class="text-capitalize text-center"><b></b>In Word : {{ \App\TraitsFolder\CommonTrait::wordAmount($sell->amount) }} {{ $basic->currency }} Only.</td>
                        </tr>
                    </table>
                </div>
            </div>
