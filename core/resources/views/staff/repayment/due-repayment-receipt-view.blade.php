                                ...
                                <div id="invoice-template" class="card-body">
                                    ...
                                    <div id="invoice-company-details" class="row">
                                        ...
                                        <div class="col-md-8 col-sm-12 text-center text-md-right">
                                            ...
                                            <ul class="px-0 list-unstyled">
                                                <li><div class="badge badge-danger font-weight-bold text-uppercase">Due Repayment</div></li>
                                                <li class="lead text-bold-800">{{ $basic->currency }} {{ $sell->pay_amount }}</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <!--/ Invoice Company Details -->
                                    ...
                                    <div id="invoice-customer-details" class="row pt-2">
                                        ...
                                        <div class="col-md-6 col-sm-12 text-center text-md-right">
                                            <p>
                                                <span class="text-muted"></span> {{ \Carbon\Carbon::parse($sell->due_payment_date)->format('dS-F-Y') }}</p>
                                        ...
                                        <div class="row">
                                            <div class="table-responsive col-sm-12">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <td>{{ $sell->custom }}</td>
                                                        <td class="text-right">{{ $sell->order->due_amount + $sell->pay_amount}} - {{ $basic->currency }}</td>
                                                        <td class="text-right">{{ $sell->pay_amount }} - {{ $basic->currency }}</td>
                                                        <td class="text-right">{{ $sell->post_due }} - {{ $basic->currency }}</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tr class="bg-grey bg-lighten-4">
                                                            ...
                                                            <td class="text-bold-800 text-right">{{ $sell->post_due + $sell->pay_amount }} - {{ $basic->currency }}</td>
                                                        </tr>
                                                        <tr class="bg-grey bg-lighten-4">
                                                        ...
                                                        <tr class="bg-grey bg-lighten-4">
                                                            ...
                                                            <td class="red text-bold-800 text-right">{{ $sell->post_due }} - {{ $basic->currency }}</td>
                                                        </tr>
                                                        ...
                                                        @endif
                                                        <tr>
                                                            <td colspan="2" class="text-capitalize"><b>In word :</b> {{ \App\TraitsFolder\CommonTrait::wordAmount($sell->post_due + $sell->pay_amount) }} {{ $basic->currency }} Only.</td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                    ...
                                    <div id="invoice-footer">
                                        <div class="row">
                                            <div class="col-md-5 col-sm-12 offset-7 text-center">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <a href="{{ route('staff-due-repayment') }}" class="btn btn-primary btn-block btn-lg text-uppercase my-1"><i class="fa fa-arrow-left"></i> Another</a>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <a href="{{ route('staff-due-repayment-receipt-print',$sell->custom) }}" target="_blank" class="btn btn-primary btn-block btn-lg text-uppercase my-1"><i class="fa fa-print"></i> Print</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
