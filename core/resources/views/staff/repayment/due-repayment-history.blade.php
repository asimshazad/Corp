                                ...
                                <table class="table table-striped table-bordered table-hover zero-configuration">
                                    ...
                                    @foreach($history as $k => $p)
                                        <tr class="{{ $p->deleted_at != null ? 'bg-warning white' : '' }}">
                                            ...
                                            <td>
                                                <a href="{{ route('staff-due-repayment-receipt-view',$p->custom) }}" class="btn btn-primary btn-sm font-weight-bold text-uppercase" title="View"><i class="fa fa-eye"></i> View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
