                                    ...
                                    <div id="invoice-footer">
                                        <div class="row">
                                            <div class="col-md-5 col-sm-12 offset-7 text-center">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <a href="{{ route('staff-instalment-repayment') }}" class="btn btn-primary btn-block btn-lg text-uppercase my-1"><i class="fa fa-arrow-left"></i> Another</a>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <a href="{{ route('staff-instalment-repayment-invoice-print',$sell->custom) }}" target="_blank" class="btn btn-primary btn-block btn-lg text-uppercase my-1"><i class="fa fa-print"></i> Print</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
