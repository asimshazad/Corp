        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title text-center" id="horz-layout-basic">Payment Method</h4>
                    </div>
                            ...
                            <div class="card box-shadow-0">
                                <div class="card-content collpase show">
                                    <div class="card-body text-center">
                                        ...
                                        <br>
                                        <br>
                                        <a href="{{ route('chose-payment-method') }}" class="btn btn-outline-info font-weight-bold text-uppercase btn-min-width mr-1 mb-1">Another Method</a>
                                        <br>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body text-center">
                            <h3>Plan Price : {{ $payment->user->plan->price }} {{ $basic->currency }}</h3>
                            <h3>Total Price : {{ $payment->amount }} {{ $basic->currency }}</h3>
                            <h3>IN USD : {{ $payment->usd }} USD</h3>
                            <hr>
                            ...
                            @if($payment->payment_id == 1)
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <form action="https://secure.paypal.com/uk/cgi-bin/webscr" method="post" name="paypal" id="paypal">
                                        ...
                                        <input type="hidden" name="business" value="{{ $payment->paymentMethod->val1 }}" />
                                        <input type="hidden" name="cbt" value="{{ $basic->title }}" />
                                        <input type="hidden" name="currency_code" value="USD" />
                                        <input type="hidden" name="quantity" value="1" />
                                        <input type="hidden" name="item_name" value="Buy From {{ $basic->title }}" />

                                        <!-- Custom value you want to send and process back in the IPN -->
                                        <input type="hidden" name="custom" value="{{ $payment->order_number }}" />
                                        <input name="amount" type="hidden" value="{{ $payment->usd  }}">
                                        <input type="hidden" name="return" value="{{ route('user-dashboard') }}"/>
                                        <input type="hidden" name="cancel_return" value="{{ route('chose-payment-method') }}" />
                                        <!-- Where to send the PayPal IPN to. -->
                                        <input type="hidden" name="notify_url" value="{{ route('paypal-ipn') }}" />
                                        <br><br><br><br>
                                        <button class="btn btn-primary btn-lg btn-block"><i class="fa fa-paypal"></i> Payment Now</button>
                                        <br><br><br><br><br>
                                    </form>
                                </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 ">
                                    <form role="form" method="POST" action="{{ route('stripe-submit') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="col-md-12 text-left"><strong style="text-transform: uppercase;">CARD NUMBER</strong></label>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="col-md-12 text-left"><strong style="text-transform: uppercase;">EXP MONTH</strong></label>
                                                    <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="col-md-12 text-left"><strong style="text-transform: uppercase;">EXP YEAR</strong></label>
                                                    <div class="col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="col-md-12 text-left"><strong style="text-transform: uppercase;">CVC CODE</strong></label>
                                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <button class="subscribe btn btn-primary btn-lg btn-block" type="submit">Payment Now</button>
                                        </div>
                                    </form>
                                </div>
                                </div>
                            ...
                            @elseif($payment->payment_id == 5)
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <form action="https://www.moneybookers.com/app/payment.pl" method="post">
                                        ...
                                        <br><br><br><br>
                                        <button class="btn btn-primary btn-lg bg-softwarezon-x border-0 btn-block"><i class="fa fa-send"></i> Payment Now</button>
                                        <br><br><br><br>
                                    </form>
                                </div>
                            @elseif($payment->payment_id == 6)
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <form action="https://www.coinpayments.net/index.php" method="post">
                                        ...
                                        <br><br><br><br>
                                        <input type="image" src="https://www.coinpayments.net/images/pub/buynow-wide-blue.png" alt="Pay with CoinPayments.net">
                                        <br><br><br><br>
                                    </form>
                                </div>
                            @endif
