                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('product-new') }}" class="form-horizontal" method="post" role="form">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input name="name" class="form-control bold" value="{{ old('name') }}" placeholder="{{ __('product.p_name') }}" required/>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input name="code" class="form-control bold" value="{{ old('code') }}" placeholder="{{ __('product.short_code') }}" required/>
                                    ...
                                    <div class="form-group col-12 mb-2 contact-repeater">
                                        ...
                                        <div data-repeater-list="specification">
                                            <div class="input-group mb-1" data-repeater-item>
                                                <input name="specification" class="form-control bold" value="{{ old('specification') }}" placeholder="{{ __('product.p_specs') }}" required/>
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-block btn-lg"><i class="fa fa-send"></i> {{ __('product.create') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
