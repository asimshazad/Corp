                            ...
                            {!! Form::model($product,['route'=>['product-update',$product->id],'method'=>'put','class'=>'form-horizontal','role'=>'form']) !!}
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">{{ __('product.p_brand') }}</strong></label>
                                                <div class="col-md-12">
                                                    <select name="company_id" id="company_id" required class="form-control select2 font-weight-bold">
                                                        <option value="" class="font-weight-bold">{{ __('product.select_one') }}</option>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">{{ __('product.p_cat') }}</strong></label>
                                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">{{ __('product.p_name') }}</strong></label>
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input name="name" class="form-control bold" value="{{ $product->name }}" placeholder="{{ __('product.p_name') }}" required/>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="col-md-12"><strong style="text-transform: uppercase;">{{ __('product.short_code') }} </strong></label>
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input name="code" class="form-control bold" value="{{ $product->code }}" placeholder="{{ __('product.short_code') }}" required/>
                                    ...
                                    <div class="form-group col-12 mb-2 contact-repeater">
                                        <label><strong style="text-transform: uppercase;">{{ __('product.p_specs') }}</strong></label>
                                        <div data-repeater-list="specification">
                                            @foreach($product->specifications as $sp)
                                            <div class="input-group mb-1" data-repeater-item>
                                                <input name="specification" class="form-control bold" value="{{ $sp->name }}" placeholder="{{ __('product.p_specs') }}" required/>
                                        ...
                                        <button type="button" data-repeater-create class="btn btn-primary font-weight-bold">
                                            <i class="fa fa-plus"></i>{{ __('product.add_new_specs') }}
                                        </button>
                                    </div>
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-block btn-lg"><i class="fa fa-send"></i> {{ __('product.update_product') }} </button>
                                    </div>
                                </div>
                            {!! Form::close() !!}
                        </div>
