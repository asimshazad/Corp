                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary btn-block font-weight-bold btn-lg text-uppercase">
                                    <i class="fa fa-search"></i> {{ __('store.check_store') }}</button>
                            </div>
                        </div>
                        {!! Form::close() !!}
                                ...
                                <table class="table table-striped table-bordered table-hover zero-configuration">
                                    ...
                                    @foreach($product as $k => $p)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $p->product->codes()->whereStatus(0)->count() }} - {{ __('common.items') }}</td>
                                            <td>
                                                <a href="{{ route('store-search-view',$p->product_id) }}" class="btn btn-primary btn-sm text-uppercase font-weight-bold" title="{{ __('common.view') }}"><i class="fa fa-eye"></i>{{ __('store.v_store') }} </a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
