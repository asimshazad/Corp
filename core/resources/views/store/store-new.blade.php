                        ...
                        <div class="card-body">
                            ...
                            {!! Form::open(['class'=>'form-horizontal','role'=>'form']) !!}
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input name="reference" class="form-control font-weight-bold" value="{{ old('reference') }}" placeholder="{{ __('store.reference') }}" required/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input class="form-control font-weight-bold input-lg" name="warranty" value="" placeholder="{{ __('store.warranty') }}" type="number" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input class="form-control font-weight-bold input-lg" name="buy_price" value="" placeholder="{{ __('store.c_p') }}" type="text" required>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input class="form-control font-weight-bold input-lg" name="sell_price" value="" placeholder="{{ __('store.sell_price') }}" type="text" required>
                                                        <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group col-12 mb-2 contact-repeater">
                                        ...
                                        <div data-repeater-list="codes">
                                            <div class="input-group mb-1" data-repeater-item>
                                                <input name="code" class="form-control font-weight-bold" value="" placeholder="{{ __('store.p_barcode') }}" required/>
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary btn-block font-weight-bold btn-lg text-uppercase"><i class="fa fa-send"></i> {{ __('store.store') }}</button>
                                    </div>
                                </div>
                            {!! Form::close() !!}
