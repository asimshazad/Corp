                                ...
                                <div id="invoice-template" class="card-body">
                                    ...
                                    <div id="invoice-company-details" class="row">
                                        ...
                                        <div class="col-md-8 col-sm-12 text-center text-md-right">
                                            ...
                                            <ul class="px-0 list-unstyled">
                                                @if($sell->status == 1)
                                                    <li><div class="badge badge-success font-weight-bold text-uppercase">{{ __('common.paid') }}</div></li>
                                                @elseif($sell->status == 2)
                                                    <li><div class="badge badge-warning font-weight-bold text-uppercase">{{ __('common.due') }}</div></li>
                                                    <li class="lead text-bold-800">{{ $basic->currency }} {{ $sell->due_amount }}</li>
                                                @else
                                                    <li><div class="badge badge-danger font-weight-bold text-uppercase">{{ __('common.instalment') }}</div></li>
                                                    <li class="lead text-bold-800">{{ $basic->currency }} {{ $sell->due_amount }}</li>
                                                @endif
                                    ...
                                    <div id="invoice-customer-details" class="row pt-2">
                                        <div class="col-sm-12 text-center text-md-left">
                                            <p class="font-weight-bold">{{ __('sell.bill_to') }}</p>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-12 text-center text-md-right">
                                            ...
                                            <p><span class="text-muted">{{ __('sell.terms') }}  :</span>
                                                @if($sell->payment_type == 0)
                                                     {{ __('common.on_paid') }}
                                                @elseif($sell->payment_type == 1)
                                                    {{ __('common.due_payment') }}  Due Payment <br> {{ \Carbon\Carbon::parse($sell->due_payment_date)->format('dS F, Y') }}
                                                @else
                                                    Instalment
                                                @endif
                                            </p>
                                        ...
                                        <div class="row">
                                            <div class="table-responsive col-sm-12">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <th>{{ __('common.sl') }}</th>
                                                        <th>{{ __('common.item_category') }}</th>
                                                        <th>{{ __('common.item_desc') }}</th>
                                                        <th class="text-right">{{ __('common.warranty') }}</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">{{ $sl->store->warranty }} - {{ __('common.days') }}</td>
                                    ...
                                    <div id="invoice-footer">
                                        <div class="row">
                                            <div class="col-md-5 col-sm-12 offset-7 text-center">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <a href="{{ route('sell-new') }}" class="btn btn-primary btn-block btn-lg text-uppercase my-1"><i class="fa fa-arrow-left"></i> Sell Another</a>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <a href="{{ route('print-invoice',$sell->custom) }}" target="_blank" class="btn btn-primary btn-block btn-lg text-uppercase my-1"><i class="fa fa-print"></i> Print Invoice</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
