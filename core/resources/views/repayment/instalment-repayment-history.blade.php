                    ...
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <a class="btn btn-primary font-weight-bold text-uppercase" href="{{ route('instalment-repayment') }}">
                                    <i class="fa fa-plus"></i>  {{ __('sidebar.new_payment') }}
                                </a>
                                <a class="btn btn-success font-weight-bold text-uppercase" href="{{ route('upcoming-instalment-repayment') }}">
                                    <i class="fa fa-plus"></i>  {{ __('sidebar.upcoming_payment') }}
                                </a>
                            </ul>
                        </div>
                    </div>
                                ...
                                <table class="table table-striped table-bordered table-hover zero-configuration">
                                    ...
                                    @foreach($history as $k => $p)
                                        <tr class="{{ $p->deleted_at != null ? 'bg-warning white' : '' }}">
                                            ...
                                            <td>
                                                <a href="{{ route('instalment-repayment-invoice',$p->custom) }}" class="btn btn-primary btn-sm font-weight-bold text-uppercase" title="View"><i class="fa fa-eye"></i> View</a>
