            ...
            <div class="modal-content" >
                ...
                <div class="modal-body">
                    <form id="frmProducts" action="{{ route('submit-instalment-repayment') }}" method="post" name="frmProducts" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-md-12"><strong style="text-transform: uppercase;">Recovery Man</strong></label>
                            <div class="col-md-12">
                                <div class="input-group">
                                    <input type="text" name="recovery_man" id="recovery_man" class="form-control font-weight-bold" value="" placeholder="Recovery man" required/>
                                </div>
                            </div>
                        </div>
