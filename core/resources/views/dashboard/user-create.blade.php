                        ...
                        <div class="card-body">
                            <form class="form form-horizontal" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control" for="projectinput1"><b>Password : </b></label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control" for="projectinput1"><b>Confirm Password : </b></label>
                                        <div class="col-md-8">
