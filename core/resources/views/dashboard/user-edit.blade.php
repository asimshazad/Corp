                            ...
                            <form class="form form-horizontal" action="{{ route('user-update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control" for="projectinput1"><b>Name : </b></label>
                                        <div class="col-md-8">
                                            <input type="text" id="projectinput1" class="form-control font-weight-bold" value="{{$user->name}}" placeholder="Name" name="name" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control" for="projectinput1"><b>Email : </b></label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control" for="projectinput1"><b>Country Code : </b></label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control" for="projectinput1"><b>Phone : </b></label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control" for="projectinput1"><b>Telegram Username : </b></label>
                                        <div class="col-md-8">
                                            <input type="text" id="projectinput1" class="form-control font-weight-bold" value="{{$user->telegram_username}}" placeholder="Telegram Username" name="telegram_username">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 label-control" for="projectinput1"><b>Select Plan : </b></label>
                                        <div class="col-md-8">
