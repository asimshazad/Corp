...
@section('content')
    ...
    <div class="spacer form2" style="height: 550px;">
        <div class="container">
            <div class="row justify-content-center">
                    ...
                    <div class="text-box">
                        ...
                        <form class="m-t-20" action="{{ route('password.request') }}" autocomplete="off" method="post" data-aos="fade-left" data-aos-duration="1200">
                            ...
                            <div class="row">
                                ...
                                @endif
                                <div class="col-lg-12">
                                    <button type="submit" class="btn btn-md btn-block btn-info-gradiant btn-arrow"><span> Reset Password <i class="ti-arrow-right"></i></span></button>
                                    <!--  -->
                                </div>
                            </div>
                        </form>
