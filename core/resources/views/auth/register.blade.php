    ...
    <div class="spacer form2">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                    <div class="text-box">
                        <h1 class="font-light">{{ $section->register_title }}</h1>
                        <p>{{$section->register_description}}</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" name="name" type="text" placeholder="Full Name" autocomplete="false" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                            ...
                                            <span class="custom-control-description">I agree to <a href="#" class="link">terms and conditions</a> and <a href="#" class="link">privacy and policy</a></span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 text-center m-t-30">
                                <div class="have-ac ml-auto align-self-center">Already have an account? <a href="{{ route('login') }}" class="text-danger">Sign In</a></div>
                            </div>
                        </div>
                    </div>
                </div>
