...
class CustomerController extends Controller
{
    ...
    public function createCustomer()
    {
        ...
        return view('staff.customer.customer-create',$data);
    }
    ...
    public function historyCustomer()
    {
        ...
        return view('staff.customer.customer-history',$data);
    }
    ...
    public function editCustomer($id)
    {
        ...
        return view('staff.customer.customer-edit',$data);
    }
    ...
    public function viewCustomer($id)
    {
        ...
        return view('staff.customer.customer-view',$data);
    }
