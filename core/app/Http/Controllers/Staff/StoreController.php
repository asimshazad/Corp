...
class StoreController extends Controller
{
    ...
    public function newStore()
    {
        ...
        return view('staff.store.store-new',$data);
    }
    ...
    public function storeHistory()
    {
        ...
        $data['history'] = Store::whereStaff_id(Auth::user()->id)->latest()->get();
        return view('staff.store.store-history',$data);
    }
    ...
    public function viewHistory($id)
    {
        ...
        return view('staff.store.store-view',$data);
    }
    ...
    public function currentStore()
    {
        ...
        $data['product'] = [];
        $data['top'] = 0;
        return view('staff.store.store-current',$data);
    }
    ...
    public function searchViewResult($id)
    {
        ...
        return view('staff.store.store-search-view',$data);
    }
